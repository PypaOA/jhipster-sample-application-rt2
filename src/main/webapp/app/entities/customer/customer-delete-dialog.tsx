...
export const CustomerDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationReactTest2App.customer.delete.question">
        <Translate contentKey="jhipsterSampleApplicationReactTest2App.customer.delete.question" interpolate={{ id: customerEntity.id }}>
