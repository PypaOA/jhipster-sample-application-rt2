...
export const OrderDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationReactTest2App.order.delete.question">
        <Translate contentKey="jhipsterSampleApplicationReactTest2App.order.delete.question" interpolate={{ id: orderEntity.id }}>
